...
(function() {
  ...
  function toggleProdMenu(close=false) {
    var menu = elem("#products-menu")
    close ? $(menu).removeClass('d-flex') : $(menu).toggleClass('d-flex')
    
  }

  $('.products-container').on('click', function(e) {
    e.stopPropagation()
    toggleProdMenu();
  } );
