  ...
  CoinDetails() {
    ...
    return (
      <div className={coin_details + " mx-auto"}>
        ...
        <div>
          Asset ID: <span className="value">{this.coin.id}</span> <a href={CONFIG.SETTINGS.EXPLORER_URL + "/object/" + this.coin.id} target="_blank"><img src="/public/images/external-link.svg" /></a><br/>
