...
const container = css`
    ...
    .leaderboard-rule.balance {
        background: url(${(window.isApp ? "": "/") + 'public/images/balance.png'}) no-repeat;
    }
    .leaderboard-rule.frequency {
        background: url(${(window.isApp ? "": "/") + 'public/images/frequency.svg'}) no-repeat;
    }
            ...
            <div id="first-time" className={container + (this.props.mobile ? " mobile" : "")}>
                <div className="content-ft">
                    <div id="contest-rules" className="d-flex">
                        <div className="left">
                            <h2>Welcome to </h2>
                            <img src={(window.isApp ? "": "/") + "public/images/qdex-fantasy.svg"} alt="QDEX Fantasy" />
                    ...
                    <div id="starting-fund">
                        <div className="flex justify-center">
                            <img onClick={() => this.openFund(this.props.mobile)} className="go-back" src={(window.isApp ? "": "/") + "public/images/back-button.svg"}/>
                            <div class="flex-center">
                                <img src={(window.isApp ? "": "/") + "public/images/coins.svg"} />
                                <h1>You have unlocked 10,000 QDEX to start trading.
                                    <img src={(window.isApp ? "": "/") + "public/images/thumb-up.svg"} />
                                </h1>
