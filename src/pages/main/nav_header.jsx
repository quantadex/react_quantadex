        ...
        return (
            <div className={container}>
                <div className="container nav-bar d-flex justify-content-end align-items-center">
                    ...
                    <a className="d-none d-sm-block launch-btn" href="https://quantadex.com/mainnet/exchange/ETH_BTC">Launch</a>
                    <div className="hamburger-menu">
                        ...
                        <div className="menu-items py-3 text-left">
                            ...
                            <a href="/blog">Blog</a>
                            <a href="https://quantadex.com/mainnet/exchange/ETH_BTC">Launch</a>
                        </div>
                    </div>
                </div>
                <hr/>
