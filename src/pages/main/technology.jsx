...
const container = css`
    .banner {
        color: #fff;
        background: #1f1e35 url('/react_quantadex/public/images/technology/tech-background.png') no-repeat;
                ...
                <div className="info container py-5">
                        ...
                        <div className="advantage d-flex justify-content-between flex-column flex-md-row ">
                            <div>
                                <div className="img-container">
                                    <img src="/react_quantadex/public/images/technology/performance.svg" />
                                </div>
                            ...
                            <div>
                                <div className="img-container">
                                    <img src="/react_quantadex/public/images/technology/secure.svg" />
                                </div>
                            ...
                            <div>
                                <div className="img-container">
                                    <img src="/react_quantadex/public/images/technology/audit.svg" />
                                </div>
                    ...
                    <section>
                        <div className="d-flex flex-column flex-sm-row justify-content-between">
                            <img className="mr-md-5" src="/react_quantadex/public/images/technology/block_chain.png" />
                    ...
                    <section>
                        <div className="d-flex flex-column-reverse flex-sm-row justify-content-between">
                            ...
                            <img className="ml-md-5" src="/react_quantadex/public/images/technology/cross_chain.png" />
                        </div>
                    </section>
