...
const container = css`
    ...
    .article {
        ...
        .paper {
            background: url(${devicePath('public/images/media/paper-tear.png')}) no-repeat 0 100%;
            height: 18px;
            width: 100%;
            text-align: right;
                ...
                <div className="d-flex justify-content-around flex-column flex-md-row">
                    <div className="article mx-auto mb-5">
                        <div className="source cryptodaily text-center">
                            <img src={devicePath("public/images/media/cryptodaily.png")} />
                        </div>
                        ...
                        <div className="paper"><img src={devicePath("public/images/media/tear_side.png")} /></div>
                    </div>
                    <div className="article mx-auto mb-5">
                        <div className="source techbullion text-center">
                            <img src={devicePath("public/images/media/techbullion.png")} />
                        </div>
                        <div className="content">
