        ...
        return (
            <React.Fragment>
                <div className={container + " toolbar-container justify-content-center qt-font-extra-small text-center " + (className || "")}>
                    ...
                    >
                        <img src={devicePath("public/images/dice/maxbet_icon.svg")} />
                        <label>Max Bet</label>
                    </div>
                    <div className={"cursor-pointer mx-5" + (sounds ? "" : " inactive")}
                        onClick={toggleSounds}
                    >
                        <img src={devicePath("public/images/dice/sound_icon.svg")} />
                        <label>Sounds</label>
                    </div>
                    { hot_keys !== undefined ?
                        ...
                        >
                            <img src={devicePath("public/images/dice/hot_keys.svg")} />
                    ...
                    <div className={"cursor-pointer mx-5" + (stats ? "" : " inactive")}
                        onClick={toggleStats}
                    >
                        <img src={devicePath("public/images/dice/live_stats.svg")} />
