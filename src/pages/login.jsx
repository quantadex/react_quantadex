...
const login_container = css`
	...
	.input-container {
		...
		label {
			...
			font-size: 11px;
			text-align: left;
			background: #f9f9f9 url(${devicePath("public/images/lock.svg")}) no-repeat 15px 12px;
		}
		input {
			height: 100%;
			width: 100%;
		...
		return (
			<div className={container}>
				<div className={login_container + (this.state.isMobile ? " mobile qt-font-light" : "")}>
					...
					<div>
						<img id="logo" src={devicePath("public/images/qdex-fantasy.svg")} alt="QDEX Fantasy"/>
			...
			<div className="d-flex">
				<div className={login_container + (this.state.isMobile ? " mobile key-reg" : "")}>
					<div className="back-nav">
						<Link to="/login"><img src={devicePath("public/images/back-button.svg")} /></Link>
					</div>
					...
					<div className="keygen content">
						...
						<h3>First Step <img className={this.state.downloaded ? "checkmark" : "d-none"} src={devicePath("public/images/check-mark.svg")} /></h3>
						...
						<div className={this.state.downloaded ? "" : "qt-opacity-half"}>
							<h3>Second Step <img className={this.state.registered ? "checkmark" : "d-none"} src={devicePath("public/images/check-mark.svg")} /></h3>
							<div className="d-flex">
								<div className="input-container">
